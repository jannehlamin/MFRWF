"""
https://github.com/GautamSridhar/FCN-implementation-on-Pytorch/blob/master/FCN8s_woVGG/FCN8_model.py
"""
import torch
...
class FCN8s(nn.Module):
    def __init__(self, nInputChannels, n_class=3):

        super(FCN8s, self).__init__()  # VGG architecture definition
        # conv1
        self.conv1_1 = nn.Conv2d(nInputChannels, 64, 3, padding=100)
...
# model = FCN8s(nInputChannels=3, n_class=3).cuda()
# model.eval()
