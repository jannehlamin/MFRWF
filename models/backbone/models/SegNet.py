# References: https://github.com/vinceecws/SegNet_PyTorch/blob/master/SegNet.py
import math
import torch
...
class SegNet(nn.Module):
    ...
    def __init__(self, num_channel=3, n_class=3):
        ...
        self.in_chn = num_channel
        self.out_chn = n_class
...
def get_10x_lr_params_segnet(model):
    """
    This generator returns all the parameters for the last layer of the net,
    which does the classification of pixel into classes
    """
    b = [model.ConvDe11, model.ConvDe12, model.ConvDe21, model.ConvDe22, model.ConvDe31, model.ConvDe32, model.ConvDe33,
         model.ConvDe41, model.ConvDe42, model.ConvDe43, model.ConvDe51, model.ConvDe52, model.ConvDe53]
...
# model = SegNet(num_channel=3, num_classes=3)
