"""source: https://github.com/zrl4836/ACFNet/blob/master/networks/acfnet.py"""
import torch.nn as nn
from torch.nn import functional as F
import torch
from ..models.bn_helper import BatchNorm2d
affine_par = True
...
def ACFNET(n_class=3, criterion=None, pretrained_model=None, **kwargs):
    model = ResNet(Bottleneck, [3, 4, 23, 3], n_class, criterion)
    return model
