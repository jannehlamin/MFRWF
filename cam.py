...
import numpy as np
import torch
from models.nets.HexaNet import HexaNet
...
def get_args():
    ...
    parser.add_argument('--status', type=str, default='0', choices=['0', '1', '2'],help='encoder hybrid used (default: agg and intra)')
    parser.add_argument('--seam', type=str, default='intra', choices=['intra', 'aggk'],help='seam name (default: intra)')
...
if __name__ == '__main__':
    ...
    # model = HexaNet(args, nclass=3, std_out=32)
    print(model)
